...
{
    public class ImagePublisher : Publisher<Messages.sensor_msgs.CompressedImage>
    {
        ...
        private Messages.sensor_msgs.CompressedImage message;
        ...
        {
            message = new Messages.sensor_msgs.CompressedImage();
