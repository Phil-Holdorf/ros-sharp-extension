...
{
    public class JointStatePublisher : Publisher<Messages.sensor_msgs.JointState>
    {
        public List<JointStateReader> JointStateReaders;
        public string FrameId = "Unity";

        private Messages.sensor_msgs.JointState message;    
        ...
        private void InitializeMessage()
        {
            ...
            message = new Messages.sensor_msgs.JointState
            {
